...
const TableComponent = ({onRowClick}) =>{
  ...
  return (
    <div className="">
      <div className="text-4xl font-extrabold  text-black font-mulish">
        Admin
      </div>

      <div className="mx-32 mt-3 border-1 border-black  h-screen  bg-gradient-to-r from-amber-800 via-amber-1000  to-amber-1500 rounded-lg">
